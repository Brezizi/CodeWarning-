...
def pbRaidBanlist
  ...
  raid_banlist = [:SMEARGLE,:SHEDINJA,:PHIONE,:FLOETTE_5,:ZYGARDE_2,:ZYGARDE_3,
                  ...
                  :ARTICUNO, :ZAPDOS, :MOLTRES, :TYPHLOSION_2, :TAUROS,
  :RAIKOU, :ENTEI, :SUICUNE, :SLAKING, :VIGOROTH, :SLAKOTH, :GIMMIGHOUL, :GHOLDENGO,
  :REGIROCK, :REGICE, :REGISTEEL, :FINIZEN, :PALAFIN, :DREEPY, :DRAKLOAK, :DRAGAPULT,
  :LATIAS, :LATIOS, :WOCHIEN, :CHIENPAO, :TINGLU, :CHIYU, :DRATINI, :LARVITAR, :BELDUM,
  :UXIE, :MESPRIT, :AZELF, :BAGON, :GIBLE, :DEINO, :JANGMOO, :FRIGIBAX, :DRAGONAIR,
  :HEATRAN, :REGIGIGAS, :CRESSELIA, :DRAGONITE, :PUPITAR, :TYRANITAR, :SHELGON, :SALAMENCE,
  :COBALION, :TERRAKION, :VIRIZION, :METANG, :METAGROSS, :GABITE, :GARCHOMP, :ZWEILOUS,
  :TORNADUS, :THUNDURUS, :LANDORUS, :HYDREIGON, :HAKAMOO, :KOMMOO,
  :TYPENULL, :SILVALLY, :ARCTIBAX, :BAXCALIBUR, :OKIDOGI, :MUNKIDORI, :FEZANDIPITI,
  :TAPUKOKO, :TAPULELE, :TAPUBULU, :TAPUFINI, :OGERPON, :ROCKRUFF_3, :LYCANROC_3,
  :KUBFU, :URSHIFU, :UNOWN_28, :UNOWN_29,
  :REGIELEKI, :REGIDRAGO,
  :GLASTRIER, :SPECTRIER,
  :MEWTWO, :LUGIA, :HOOH,
  ...
  :DIANCIE, :HOOPA, :VOLCANION, :MIRAIDON, :KORAIDON,
  :MAGEARNA, :MARSHADOW, :ZERAORA,
  :MELTAN, :MELMETAL, :ZARUDE, :NAGANADEL, :ENAMORUS]
  #-----------------------------------------------------------------------------
  # Allowable multi-form species.
  #-----------------------------------------------------------------------------
  allowed_forms = [:UNOWN,:BURMY,:WORMADAM,:SHELLOS,:GASTRODON,:ROTOM,:SNEASEL,:SNEASLER,
                   :BASCULIN,:VIVILLON,:MEOWTH,:PERSIAN,:RATICATE,:NINETALES,:VULPIX,:MAROWAK,:ZOROARK,:AVALUGG,
                   :FURFROU,:FLABEBE,:FLOETTE,:FLORGES,:MEOWSTIC,:PUMPKABOO,:SAMUROTT,:DECIDUEYE,:ARCANINE,:GROWLITHE,:LILLIGANT,:ZORUA,:VOLTORB,:ELECTRODE,:QWILFISH,:BRAVIARY,
                   :GOURGEIST,:ORICORIO,:ROCKRUFF,:LYCANROC,:BASCULEGION,:OINKOLOGNE,:MAUSHOLD,:SQUAWKABILLY,:TATSUGIRI,
                   :SINISTEA,:POLTEAGEIST,:TOXTRICITY,:INDEEDEE,:TYPHLOSION,:DUNSPARCE,:POLTCHAGEIST,:SINISTCHA,:GOODRA,:SLIGGOO]
  #-----------------------------------------------------------------------------
