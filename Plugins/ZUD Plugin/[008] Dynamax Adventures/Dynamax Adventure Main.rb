...
class DynAdventureState
  ...
  def initialize
    clear
    @treasure = {
      "Common"    => [:EXPCANDYM,:MAXHONEY,:WISHINGPIECE,
                      :TINYMUSHROOM,:PEARL,:RELICCOPPER,:RELICSILVER,:MAXPLUMAGE,
                      ...
                      :LEAFSTONE,:FIRESTONE,:WATERSTONE,:THUNDERSTONE,:EVERSTONE,
                     ],
      "Uncommon"  => [:EXPCANDYL,:DYNAMAXCANDY,:MAXMUSHROOMS,:WISHINGPIECE,
                      :BIGPEARL,:BIGMUSHROOM,:NUGGET,:RELICGOLD,:RELICVASE,
:HPUP,:PROTEIN,:IRON,:CALCIUM,:ZINC,:CARBOS,:ABILITYCAPSULE,:BALMMUSHROOM,
                      :MOONSTONE,:SUNSTONE,:ICESTONE,:DUSKSTONE,:DAWNSTONE,:SHINYSTONE,
                     ],  
      "Rare"      => [:EXPCANDYXL,:MAXSOUP,:RARECANDY,:MAXSCALES,
                      :RELICBAND,:RELICSTATUE,:BOOSTERENERGY,
                      :IVHPUP,:IVPROTEIN,:IVIRON,:IVCALCIUM,:IVZINC,:IVCARBOS,
                      :PPUP,:ABILITYPATCH,:BIGNUGGET,:PEARLSTRING,
                      :KINGSROCK
                     ],
      "Very Rare" => [:DYNAMAXCANDYXL,
                      :RELICCROWN,:PPMAX,
                      :VENUSAURITE,:CHARIZARDITEX,:CHARIZARDITEY,:BLASTOISINITE,
:ALAKAZITE,:GARDEVOIRITE,:GALLADITE,:DIANCITE,:GENGARITE,:SCIZORITE,:MAWILITE,
:MEWTWONITEX,:MEWTWONITEY,:TOGEKISSITE,:SAMUROTTITE,
:SHARPEDONITE,:CAMERUPTITE,
:METAGROSSITE,:SALAMENCITE,
:GARCHOMPITE,:SILVALOTITE,
                     ] 
    }
  end
  ...
  def pbEnd
    ...
    if abandoned?
      ...
      pbMessage(_INTL("All stats increased by +1"))
      $game_variables[14] += 1 
      $game_variables[16] += 1 
      $game_variables[17] += 1 
      $game_variables[76] += 1 
    ...
    #---------------------------------------------------------------------------
      ...
      pbMessage(_INTL("Setting a new record has vastly increased all stats!"))
      $game_variables[14] += 15 
      $game_variables[16] += 15 
      $game_variables[17] += 5 
      $game_variables[76] += 10 
      ...
      $game_variables[207] += 1 
        ...
        pbMessage(_INTL("All stats were slightly increased!"))
      $game_variables[14] += 2 
      $game_variables[16] += 2 
      $game_variables[17] += 1 
      $game_variables[76] += 2
    ...
    #---------------------------------------------------------------------------
      ...
      pbMessage(_INTL("All stats were increased for making it that far!"))
      $game_variables[14] += 5 
      $game_variables[16] += 5 
      $game_variables[17] += 2 
      $game_variables[76] += 3     
    ...
    #---------------------------------------------------------------------------
      ...
      pbMessage(_INTL("All stats were greatly increased!"))
      $game_variables[14] += 10 
      $game_variables[16] += 10 
      $game_variables[17] += 3 
      $game_variables[76] += 5  
      pbAddTreasure
    end
