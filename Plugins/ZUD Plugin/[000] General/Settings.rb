...
#-------------------------------------------------------------------------------
  ...
  :NAGANADEL, :STAKATAKA, :BLACEPHALON, :GREATTUSK, :SCREAMTAIL,:BRUTEBONNET,:FLUTTERMANE,:SLITHERWING,:GREATTUSK,:SANDYSHOCKS,:ROARINGMOON,:IRONVALIANT,:IRONTREADS,:IRONBUNDLE,:IRONHANDS,:IRONJUGULIS,:IRONMOTH,:IRONTHORNS,:WALKINGWAKE,:IRONLEAVES]
