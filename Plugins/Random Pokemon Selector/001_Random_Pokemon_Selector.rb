def pbChooseRandomPokemon(whiteList=nil, blackList=nil, addList=nil,
  ...
  choose_gen = (1..9).to_a if !choose_gen
...
def getLegendOrMythic
  ...
  :COSMOG, :COSMOEM,
  :SOLGALEO, :LUNALA, :NECROZMA, :DIPPLIN, :SINISTCHA, :OKIDOGI, :MUNKIDORI, :FEZANDIPITI, :OGERPON,
  :ZACIAN, :ZAMAZENTA, :DRAGONAIR, :DRAGONITE, :PUPITAR, :TYRANITAR, :SHELGON, :SALAMENCE, :METANG, :METAGROSS, :GABITE, :GARCHOMP, :ZWEILOUS, :HYDREIGON, :GOODRA,
  :ETERNATUS, :CALYREX, :DRATINI, :LARVITAR, :BELDUM, :BAGON, :GIBLE, :DEINO, :GOOMY, :JANGMOO, :DREEPY, :FRIGIBAX, :SLIGGOO, :HAKAMOO, :KOMMOO, :ARCTIBAX, :BAXCALIBUR,
  :MEW, :CELEBI, :JIRACHI, :FINIZEN, :PALAFIN, :REVAVROOM, :GLIMMORA, :HOUNDSTONE, :CETITAN, :GIMMIGHOUL, :GHOLDENGO, :SPECTREON, :DRAKEON, :DRAKLOAK, :DRAGAPULT,
  :DEOXYS, :PHIONE, :MANAPHY, :GARGANACL, :BELLIBOLT, :KILOWATTREL, :MABOSSTIFF, :GRAFAIAI, :BRAMBLEGHAST, :TOEDSCRUEL, :ESPATHRA, :TINKATUFF, :TINKATON, :NACLSTACK,
  :DARKRAI, :SHAYMIN, :ARCEUS, :URSALUNA, :WYRDEER, :BASCULEGION, :CLODSIRE, :SLAKOTH, :VIGOROTH, :SLAKING, :OINKOLOGNE, :SPIDOPS, :LOKIX, :PAWMO, :PAWMOT, :WUGTRIO,
  :VICTINI, :KELDEO, :MELOETTA, :GENESECT, :IRONLEAVES, :FARIGIRAF, :KINGGAMBIT, :ANNIHILAPE, :MEOWSCARADA, :FLORAGATO, :BAXCALIBUR, :ARCTIBAX, :MAUSHOLD, :RABSCA,
  :DIANCIE, :HOOPA, :VOLCANION, :MIRAIDON, :KORAIDON, :CERULEDGE, :ARMAROUGE, :SNEASLER, :QUAQUAVAL, :QUAXWELL, :SKELEDIRGE, :CROCALOR, :DACHSBUN, :ARBOLIVA,
  :MAGEARNA, :MARSHADOW, :ZERAORA, :IRONVALIANT, :IRONTREADS, :IRONBUNDLE, :IRONHANDS, :IRONJUGULIS, :IRONMOTH, :IRONTHORNS, :ENAMORUS, :WALKINGWAKE, :DUDUNSPARCE, :DOLLIV,
  :MELTAN, :MELMETAL, :ZARUDE, :SCREAMTAIL, :BRUTEBONNET, :FLUTTERMANE, :SLITHERWING, :GREATTUSK, :SANDYSHOCKS, :WOCHIEN, :CHIENPAO, :TINGLU, :CHIYU, :ROARINGMOON]
  return arr
end
